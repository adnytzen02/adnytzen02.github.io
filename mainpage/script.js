...
const ioModule = (() => {
    const exportHTML = () => {
        ...
        const html = `<!DOCTYPE html><html lang="zh-TW"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>日本購物清單</title>
            <style>
